...
> Este pré-processamento é pautado nos **microdados do Censo Escolar**, que contêm informações individualizadas e protegidas por sigilo. O acesso a esses arquivos **requer autorização prévia do INEP** e o processamento deve ser realizado via **Sala Segura (SEDAP/INEP)** ou ambiente controlado equivalente, respeitando a LGPD e os protocolos de segurança institucional.
